...
// addProduct nhận đúng 4 tham số theo ProductModel hiện tại
...
$price = $data['price'] ?? '';
$category_id = $data['category_id'] ?? null;
// updateProduct nhận đúng 5 tham số theo ProductModel hiện tại
...
if ($result) {
echo json_encode(['message' => 'Product deleted successfully']);} else {
http_response_code(400);
