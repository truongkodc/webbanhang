                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-footer">
                            <div class="d-flex flex-wrap mt-2" style="gap: 8px;">
                                ...
                                <a
                                    href="/webbanhang/Product/addToCart/<?= $product->id ?>"
...
<script>
    ...
    function draw() {
        ...
        particles.forEach((particle) => {
            ...
            if (particle.x > canvas.width + particle.r) {
            ...
            const pulse = particle.alpha + Math.sin(time + particle.pulse) * 0.06;

            ctx.beginPath();
            ctx.arc(
                particle.x,
                particle.y,
                particle.r + Math.sin(time * 0.8 + particle.pulse) * 2,
                0,
                Math.PI * 2
            );
